...
public final class manageFeed_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (((String) session.getAttribute("group")) != null) {
      ...
      out.write("    <head>\n");
      out.write("        <title>CMS - Manage Feeding</title>\n");
      ...
      out.write("                        <li class=\"active\"><a href=\"menuFood.jsp\">Food</a></li>\n");
      ...
      out.write("                <h2><a href=\"index.jsp\">Home</a> > <a href=\"menuFood.jsp\">Food</a> > Manage Feeding</h2>\n");
      out.write("                <br></br>\n");
      out.write("                <a href=\"addFeed.jsp\"><font color=\"CCA300\">Add New Feeding</font></a>\n");
      out.write("                <br></br>\n");
      out.write("                <table border=\"1\" style=\"width:100%\">\n");
      out.write("                    <tr>\n");
      out.write("                        <th>Barn ID</th>\n");
      out.write("                        <th>Food ID</th>\n");
      out.write("                        <th>Time Feed</th>\n");
      out.write("                        <th>Date Feed</th>\n");
                ...
                Connection connection = null;
                        try {
                            ...
                            while (rows.next()) {
                                ...
                                out.println("<td width=5><a href = deleteFeed.jsp?barnID=" + rows.getString("feedschedule.barnID") + ">" + "<img width=20 height=20 src=./img/delete.png>" + "</a>");                            }
                        } catch (Exception e) {
                            out.println("Error" + e);
      ...
      out.write("                    <h2>Mini Gallersssy</h2>\n");
