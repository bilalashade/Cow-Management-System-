...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > <a href="menuHealthcare.jsp">Healthcare</a> > Add Checkup</h2>
                <center><h2>Add Checkup</h2></center>
                <center><table border="1" cellpadding="5" width="100%">
                        <form name ="addCheckup" action="addCheckup2.jsp" method="GET">
                            <tr>
                                <td>Cow Tag</td>
                                <td><select name="cowTag">
                                        <option>Choose Cow Tag</option>
                                        <%                                            Connection connection = null;
                                            try {
                                                ...
                                                while (rows.next()) {
                                        %>
                                        <option value="<%=rows.getString("cow.cowTag")%>"><%=rows.getString("cow.cowTag")%></option>
                                        <%
                            ...
                            <tr>
                                <td>Checkup Date</td>
                                <td><input type="date" name="checkupDate" value="<%=ft.format(dNow)%>" size="30"></td>
                            </tr>

                            <tr>
                                <td>Checkup Time</td>
                                <td><input type="time" name="checkupTime" value="<%=ft2.format(dNow)%>" size="30"></td>
                            </tr>
                            ...
                            <tr>
                                <td>Notes</td>
                                <td><input type="text" name="notes" size="60"></td>
                            </tr>
                    </table>
