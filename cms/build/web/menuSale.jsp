...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > Sale</h2>
                <br></br>
                This is the main menu of Sale
                <br></br>
                <li><a href=addSale.jsp>Add Sale</a></li>
                <li><a href=manageSale.jsp>Manage Sale</a></li>
