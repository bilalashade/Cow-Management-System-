    ...
    <body>
        <%
            ...
            try {
                ...
                String delete2 = "delete from cow where cowTag='" + cowTag + "'";

                try {
                    int i = statement.executeUpdate(delete2);

                    if (i == 1) {
                        out.println("<script>alert('Cow Information Has Been Successfully Deleted');document.location.href='manageCow.jsp';</script>");
                    } else {
                        out.println("<script>alert('Cow Information Failed To Be Deleted');window.history.back();</script>");
                    }

                    throw new MySQLIntegrityConstraintViolationException();

                } catch (SQLException e) {
                    out.println("<script>alert('Error. Cow information is used in checkup and sales.');document.location.href='manageCow.jsp';</script>");
