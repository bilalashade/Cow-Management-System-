...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> ><a href="menuStaff.jsp">Staff</a> > Add Staff</h2>
                <center><h2>Staff Information</h2></center>
                <center><table border="1" cellpadding="5" width="100%">
                        <form name ="addStaff" action="addStaff2.jsp" method="GET">
                            <tr>
                                <td>Staff ID</td>
                            ...
                            <tr>
                                <td>Staff Name</td>
                                <td><input type="text" name="staffName" size="30"></td>
                            </tr>
