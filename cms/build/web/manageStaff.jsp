...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > <a href="menuStaff.jsp">Staff</a> > Manage Staff</h2>

                <br></br>
                <input style="width:20%" type="text" id="myInput" onkeyup="myFunction2()" placeholder="Search..." title="Type in Staff ID">
                    <div align="right"><a href="addStaff.jsp"><font color="CCA300">Add New Staff</font></a></div>
                    <div align="left"><a href="reportStaff.jsp"><font color="CCA300">Print Report</font></a></div>

                    <br></br>
                    <table id="myTable" border="1" style="width:100%">
                        <tr id="tableHeader">
                            <th onclick="sortTable(0)" align="center">Staff ID</th>
                            <th onclick="sortTable(1)" align="center">Name</th>
                            <th onclick="sortTable(2)" align="center">Job Title</th>
                            <th></th>
                            <th></th>
                        </tr>
                        <%                            String staffID = "";
                            ...
                            try {
                                ...
                                while (rows.next()) {
                                    ...
                                    out.println("<td width=5><a href = updateStaff.jsp?staffID=" + rows.getString("staff.staffID") + ">" + "<img width=20 height=20 src=./img/update.png>" + "</a>" + "</td>");
...
<script>
    function myFunction() {
        ...
        if (confirm("Are you sure want to delete this data?")) {
            document.location.href = 'deleteStaff.jsp?staffID=<%=staffID%>';
        } else {
