<%-- 
    Document   : barnList
    Created on : Apr 10, 2018, 6:41:07 AM
    Author     : Syafiq
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > <a href="menuBarn.jsp">Barn</a> > Barn List</h2>
                <br></br>
                <input style="width:20%" type="text" id="myInput" onkeyup="myFunction2()" placeholder="Search..." title="Type in barn ID">
                    <div align="right"><a href="addBarn.jsp"><font color="CCA300">Add New Barn</font></a></div>
                    <div align="left"><a href="reportBarn.jsp"><font color="CCA300">Print Report</font></a></div>
                    <br></br>
                    <center>
                        <table id="myTable" border="1" width="100%">
                            <tr id="tableHeader">
                                <th onclick="sortTable(0)">Barn ID</th>
                                <th onclick="sortTable(1)">Barn Type</th>
                                <th onclick="sortTable(2)">Date Build</th>
                                <th></th>
                                <th></th>
                            </tr>
                            <%                                String barnID = "";
                                ...
                                try {
                                    ...
                                    String querySelect = "select * from barn";

                                    ResultSet rows = statement.executeQuery(querySelect);
                                    while (rows.next()) {

                                        barnID = rows.getString("barn.BarnID");
                                        out.println("<tr><td align=center><a href = barnInfo.jsp?barnID=" + rows.getString("barn.BarnID") + ">" + rows.getString("barn.barnID") + "</a>" + "</td>");
                                        out.println("<td align=center>" + rows.getString("barn.barnType") + "</td>");
                                        out.println("<td align=center>" + rows.getString("barn.yearBuilt") + "</td>");
                                        out.println("<td align=center  width=5><a href = updateBarn.jsp?barnID=" + rows.getString("barn.barnID") + ">" + "<img width=20 height=20 src=./img/update.png>" + "</a></td>");
                                        out.println("<td width=5><a onclick=myFunction(); >" + "<img width=20 height=20 src=./img/delete.png>" + "</a>" + "</td></tr>");
                                    }
                                } catch (Exception e) {
                                    out.println("Error" + e);
...
<script>
    function myFunction() {
        ...
        if (confirm("Are you sure want to delete this data?")) {
            document.location.href = 'deleteBarn.jsp?barnID=<%=barnID%>';
        } else {
