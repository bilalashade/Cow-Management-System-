...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > <a href="menuFood.jsp">Food</a> > Add Feeding</h2>
                <center><h2>Feeding Information</h2></center>
                <center><table border="1" cellpadding="5" width="100%">
                        <form name ="addFeed" action="addFeed2.jsp" method="GET">

                            <tr>
                                <td>Barn ID</td>
                                <td><select name="barnID">
                                        <option>Choose Barn</option>
                                        ...
                                        <option value="<%=rows.getString("barnID")%>"><%=rows.getString("barnID")%> (<%=rows.getString("barnType")%>)</option>
                                ...
                                <td><select name="foodID">
                                        ...
                                        <%
                                            try {
                                                ...
                                                connection = DriverManager.getConnection(url, user, pwd);
                                                Statement statement = connection.createStatement();
                                                String querySelect2 = "select * from food";
                                        ...
                                        <option value="<%=rows2.getString("foodID")%>"><%=rows2.getString("foodID")%> - <%=rows2.getString("foodName")%> (<%=rows2.getString("foodType")%>) - <%=rows2.getString("quantity")%></option>
                            ...
                            <tr>
                                ...
                                <td>Time Feed</td>
                                <td><input type="time" name="timeFeed" value="<%=ft.format(dNow)%>" size="30"></td>
                            </tr>
                            <tr>
                                <td>Date Feed</td>
                                <td><input type="date" name="dateFeed" value="<%=ft2.format(dNow)%>" size="30"></td>
                            </tr>
