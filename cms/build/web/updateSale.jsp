...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > <a href="menuSale.jsp">Sale</a> > <a href="manageSale.jsp">Sale Report</a> > Update Sale</h2>
                <%            String staffID = request.getParameter("staffID");
                    ...
                    try {
                        ...
                        String querySelect = "select * from sale WHERE cowTag='" + cowTag + "'";

                        ResultSet rows = statement.executeQuery(querySelect);
                        while (rows.next()) {
                %>

                <center><h2>Sale Information</h2></center>
                <center><table border="1" cellpadding="5" width="100%">
                        <form name ="updateSale" action="updateSale2.jsp" method="GET">
                            <tr>
                                <td>Cow Tag</td>
                                <td><%=cowTag%></td>
                            </tr>
                            ...
                            <tr>
                                <td>Buyer's Name</td>
                                <td><input type="text" name="saleName" value="<%=rows.getString("saleName")%>" size="30"></td>
                            </tr>
                            ...
                            <tr>
                                <td>Sale Date</td>
                                <td><input type="date" name="saleDate" value="<%=rows.getString("saleDate")%>"></td>
                            </tr>
                            ...
                            <tr>
                                <td>Price</td>
                                <td>RM <input type="text" name="price" value="<%=rows.getString("price")%>" size="30"></td>
                            </tr>
