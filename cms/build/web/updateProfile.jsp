...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>CMS - Update Profile</title>
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > <a href="menuUser.jsp">User</a> > <a href="profile.jsp">Profile</a> > Update Profile</h2>
                <center><h2>Staff Information</h2></center>
                <form name ="editStaff" action="updateProfile2.jsp" method="GET">
