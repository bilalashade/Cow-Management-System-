...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > Healthcare</h2>
                <br></br>
                This is the main menu of Cow Healthcare
                <br></br>
                <li><a href=addCheckup.jsp>Add Checkup</a></li>
                <li><a href=manageCheckup.jsp>Checkup Report</a></li>
                <li><a href=manageTreatment.jsp>Manage Treatment</a></li>
                <li><a href=managePastTreatment.jsp>Treatment Report</a></li>
