...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > Food</h2>
                <br></br>
                This is the main menu of Cow Food.
                <br></br>
                <li><a href=addFood.jsp>Add Food</a></li>
                <li><a href=manageFood.jsp>Manage Food</a></li>
                <li><a href=addFeed.jsp>Add Feeding</a></li>
                <li><a href=manageFeed.jsp>Manage Feeding</a></li>
