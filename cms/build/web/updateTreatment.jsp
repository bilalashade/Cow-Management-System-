...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>CMS - Update Treatment</title>
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > <a href="menuHealthcare.jsp">Healthcare</a> > <a href="managePastTreatment.jsp">Manage Treatment</a> > Update Treatment</h2>
                <br></br>
                <center><table border="1" cellpadding="5" width="100%">
                        <form name ="updateTreatment" action="updateTreatment2.jsp" method="GET">
                            ...
                            <%                                String cowTag = request.getParameter("cowTag");
                                ...
                                try {
                                    ...
                                    String querySelect = "select * from treatment WHERE checkupDateTime='" + checkupDateTime + "' &&  treatmentDateTime='" + treatmentDateTime + "'";
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="medicineMethod" value="<%=rows.getString("medicineMethod")%>" size="60"></td>
                            </tr>
                            <%
                                    }
                                } catch (Exception e) {
                            ...
                            <tr>
                                ...
                                <td><select name="medicineID">
                                        ...
                                        <%                                            try {
                                                ...
                                                while (rows2.next()) {
                                        %>
                                        <option value="<%=rows2.getString("medicine.medicineID")%>"><%=rows2.getString("medicine.medicineID")%> - <%=rows2.getString("medicine.medicineName")%></option>
                                        <%
                    ...
                    <input type="hidden" name="checkupDate" value="<%=checkupDate%>">
                        <input type="hidden" name="checkupTime" value="<%=checkupTime%>">
                            <input type="hidden" name="treatmentDate" value="<%=treatmentDate%>">
