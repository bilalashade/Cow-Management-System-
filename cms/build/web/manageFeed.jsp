...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>CMS - Manage Feeding</title>
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > <a href="menuFood.jsp">Food</a> > Manage Feeding</h2>
                <br></br>
                <input  style="width:20%" type="text" id="myInput" onkeyup="myFunction2()" placeholder="Search..." title="Type in Feed ID">

                    <div align="right"><a href="addFeed.jsp"><font color="CCA300">Add New Feed</font></a></div>
                    <div align="left"><a href="reportFeed.jsp"><font color="CCA300">Print Report</font></a></div>

                    <br></br>
                    <table id="myTable" border="1" style="width:100%">
                        <tr id="tableHeader">
                            <th onclick="sortTable(0)" align="center">Barn ID</th>
                            <th onclick="sortTable(1)" align="center">Food ID</th>
                            <th onclick="sortTable(2)" align="center">Time Feed</th>
                            <th onclick="sortTable(3)" align="center">Date Feed</th>
                            <th onclick="sortTable(4)" align="center">Quantity</th>
                            <th></th>
                            <th></th>
                        ...
                        <%                String timeFeed = "";
                            ...
                            try {
                                ...
                                String querySelect = "select * from feedschedule";

                                ResultSet rows = statement.executeQuery(querySelect);
                                while (rows.next()) {
                                    barnID = rows.getString("feedschedule.barnID");
                                    timeFeed = rows.getString("feedschedule.timeFeed");
                                    dateFeed = rows.getString("feedschedule.dateFeed");
                                    out.println("<tr><td align=center>" + rows.getString("feedschedule.barnID") + "</td>");
                                    out.println("<td align=center>" + rows.getString("feedschedule.foodID") + "</td>");
                                    out.println("<td align=center>" + rows.getString("feedschedule.timeFeed") + "</td>");
                                    out.println("<td align=center>" + rows.getString("feedschedule.dateFeed") + "</td>");
                                    out.println("<td align=center>" + rows.getString("feedschedule.quantity") + "</td>");
                                    out.println("<td width=5><a href = updateFeed.jsp?barnID=" + rows.getString("feedschedule.barnID") + "&dateFeed=" + rows.getString("feedschedule.dateFeed") + "&timeFeed=" + rows.getString("feedschedule.timeFeed") + ">" + "<img width=20 height=20 src=./img/update.png>" + "</a>" + "</td>");
...
<script>
    function myFunction() {
        ...
        if (confirm("Are you sure want to delete this data?")) {
            document.location.href = 'deleteFeed.jsp?dateFeed=<%=dateFeed%>&timeFeed=<%=timeFeed%>&barnID=<%=barnID%>';
        } else {
