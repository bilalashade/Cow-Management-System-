...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > <a href="menuFood.jsp">Food</a> > Add Food</h2>
                <center><h2>Food Information</h2></center>
                <center><table border="1" cellpadding="5" width="100%">
                        <form name ="addFood" action="addFood2.jsp" method="GET">
                            <tr>
                                <td>Food ID</td>
                                <td><input type="text" name="foodID" size="30"></td>
                            </tr>

                            <tr>
                                <td>Food Name</td>
                                <td><input type="text" name="foodName" size="30"></td>
                            </tr>
