<%-- 
    Document   : updateBarn
    Created on : Apr 10, 2018, 6:49:25 AM
    Author     : Syafiq
--%>
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                ...
                <h2><a href="index.jsp">Home</a> > <a href="menuBarn.jsp">Barn</a> > <a href="barnList.jsp">Barn List</a> > Update Barn</h2>
                <center><h2>Barn Information</h2></center>
                <center><table border="1" cellpadding="5" width="100%">
                        <form name ="updateBarn" action="updateBarn2.jsp" method="GET">
                            <tr>
                                <td>Barn ID</td>
                                <td><%=barnID%></td>
                            </tr>
                            ...
                            <%
                                ...
                                try {
                                    ...
                                    String querySelect2 = "select * from barn WHERE barnID='" + barnID + "'";
                            ...
                            <tr>
                                <td>Width</td>
                                <td><input type="text" name="width" value="<%=rows2.getString("width")%>" size="30"> Metres </td>
                            </tr>

                            <tr>
                                <td>Height</td>
                                <td><input type="text" name="height" value="<%=rows2.getString("height")%>" size="30"> Metres </td>
                            </tr>

                            <tr>
                                <td>Length</td>
                                <td><input type="text" name="length" value="<%=rows2.getString("length")%>" size="30"> Metres </td>
                            </tr>

                            <tr>
                                <td>Date Build</td>
                                <td><input type="date" name="yearBuilt" value="<%=rows2.getString("yearBuilt")%>" size="30"></td>
                            </tr>
                    </table>
                    <br>
