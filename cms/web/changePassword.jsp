...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > <a href="menuUser.jsp">User</a> > <a href="profile.jsp">Profile</a> > Change Password</h2>
                <br></br>
                <form name="changePassword.jsp" action="changePassword2.jsp" method="post">
                    <table border="1" width="100%">
                        ...
                        <tr>
                            <td>New Password</td>
                            <td width="60%"><input type="password" name="NewPassword" id=password onkeyup='check();'></td>
                        </tr>

                        <tr>
                            <td>Re-type New Password</td>
                            <td width="60%"><input type="password" name="RetypePassword" id="confirm_password"  onkeyup='check();'> <span id='message'></span></td>
                        </tr>
