...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > <a href="menuFood.jsp">Food</a> > <a href="manageFood.jsp">Manage Food</a> > Update Food</h2>
                <br></br>
                <%                    String foodID = request.getParameter("foodID");
                    ...
                    try {
                        ...
                        String querySelect = "select * from food WHERE foodID='" + foodID + "'";

                        ResultSet rows = statement.executeQuery(querySelect);
                        while (rows.next()) {
                %>
                <h1>UPDATE FOOD</h1>
                <center><h2>Food Information</h2></center>
                <center><table border="1" cellpadding="5" width="100%">
                        <form name ="updateFood" action="updateFood2.jsp" method="GET">
                            <tr>
                                <td>Food ID</td>
                                <td><%=foodID%></td>
                            </tr>
                            ...
                            <tr>
                                <td>Food Name</td>
                                <td><input type="text" name="foodName" value="<%=rows.getString("foodName")%>" size="30"></td>
                            </tr>
