...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > <a href="menuUser.jsp">User</a> > Profile</h2>
                ...
                <center><table border="1" cellpadding="5" width="100%">
                        ...
                        <%                    Connection connection = null;
                            try {
                                ...
                                String querySelect = "select * from staff WHERE staffID='" + userID + "'";
                        ...
                        <tr>
                            <td>Staff Name</td>
                            <td><%=rows.getString("staffName")%></td>
                        </tr>
                        ...
                        <tr>
                            <td>Telephone No</td>
                            <td><%=rows.getString("noTel")%></td>
                        </tr>

                        <tr>
                            <td>E-mail</td>
                            <td><%=rows.getString("email")%></td>
                        </tr>

                    </table>
                        <table border="0">
                            <tr>
                                <td><form name="updateProfile" action="updateProfile.jsp" method="get">
                        <input type="submit" value="Update Profile">
                    </form></td>
                                <td><form name="changePassword" action="changePassword.jsp" method="get">
