    ...
    <body>
        <%
            ...
            try {
                ...
                String delete = "DELETE FROM checkup WHERE cowTag='" + cowTag + "' && checkupDateTime='" + checkupDateTime + "'";

                int i = statement.executeUpdate(delete);

                if (i == 1) {
                    out.println("<script>alert('Checkup Information Has Been Successfully Deleted');document.location.href='manageCheckup.jsp';</script>");
                } else {
