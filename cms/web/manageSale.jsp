...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > <a href="menuSale.jsp">Sale</a> > Manage Sale</h2>
                <br></br>
                <input style="width:20%" type="text" id="myInput" onkeyup="myFunction2()" placeholder="Search..." title="Type in Cow Tag">
                    <div align="right"><a href="addSale.jsp"><font color="CCA300">Add New Sale</font></a></div>
                    <div align="left"><a href="reportSale.jsp"><font color="CCA300">Print Report</font></a></div>

                    <br></br>
                    <table id="myTable" border="1" style="width:100%">
                        <tr id="tableHeader">
                            <th onclick="sortTable(0)" align="center">Cow Tag</th>
                            <th onclick="sortTable(1)" align="center">Buyer's Name</th>
                            <th onclick="sortTable(2)" align="center">Contact No</th>
                            <th onclick="sortTable(3)" align="center">Sale Date</th>
                            <th onclick="sortTable(4)" align="center">Price</th>
                            <th></th>
                            <th></th>
                        </tr>
                        <%
                            ...
                            try {
                                ...
                                while (rows.next()) {
                                    ...
                                    out.println("<td width=5><a href = updateSale.jsp?cowTag=" + rows.getString("sale.cowTag") + ">" + "<img width=20 height=20 src=./img/update.png>" + "</a>" + "</td>");
...
<script>
    function myFunction() {
        ...
        if (confirm("Are you sure want to delete this data?")) {
            document.location.href = 'deleteSale.jsp?cowTag=<%=cowTag%>';
        } else {
