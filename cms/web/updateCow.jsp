            ...
            <div id="latest">
                <%
                    ...
                    try {
                        ...
                        while (rows.next()) {
                %>
                <h2><a href="index.jsp">Home</a> > <a href="menuCow.jsp">Cow</a> > <a href="manageCow.jsp">Manage Cow</a> > Update Cow</h2>
                <center><h2>Cow Information</h2></center>
                <center><table border="1" cellpadding="5" width="100%">
                        <form name ="updateCow" action="updateCow2.jsp" method="GET">
                            <tr>
                                <td>Cow Tag</td>
                                <td><%=cowTag%></td>
                            </tr>
                            ...
                            <tr>
                                <td>Early Age</td>
                                <td><input type="text" name="EarlyAge" value="<%=rows.getString("earlyAge")%>" size="30"></td>
                            </tr>

                            <tr>
                                <td>Early Weight</td>
                                <td><input type="text" name="EarlyWeight" value="<%=rows.getString("earlyWeight")%>" size="30"></td>
                            </tr>
