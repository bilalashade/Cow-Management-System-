...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > Barn</h2>
                <br></br>
                This is the main menu of Barn
                <br></br>
                <li><a href=addBarn.jsp>Add Barn</a></li>
                <li><a href=barnList.jsp>Barn List</a></li>
                <li><a href=manageBarn.jsp>Manage Barn</a></li>
