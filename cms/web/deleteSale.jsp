...
<%-- 
    Document   : deleteSale
    Created on : Apr 17, 2018, 5:12:46 AM
    Author     : Syafiq
--%>
    ...
    <body>
        <%
            ...
            try {
                ...
                String delete2 = "delete from sale where cowTag='" + cowTag + "'";

                int i = statement.executeUpdate(delete2);

                if (i == 1) {
                    out.println("<script>alert('Cow Information Has Been Successfully Deleted');document.location.href='manageSale.jsp';</script>");
                } else {
