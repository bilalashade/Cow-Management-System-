...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > <a href="menuSale.jsp">Sale</a> > <a href="manageSale.jsp">Manage Sale</a> > Add Sale</h2>
                <center><h2>Sale Information</h2></center>
                <center><table border="1" cellpadding="5" width="100%">
                        <form name ="addSale" action="addSale2.jsp" method="GET">
                            <tr>
                                <td>Cow Tag</td>
                                <td><select name="cowTag">
                                        <option>Choose Cow </option>
                                        <%
                                            ...
                                            try {
                                                ...
                                                String querySelect2 = "select * from cow where cowStatus!='sold'";
                                        ...
                                        <option value="<%=rows2.getString("cowTag")%>"><%=rows2.getString("cowTag")%></option>
                            ...
                            <tr>
                                <td>Buyer's Name</td>
                                <td><input type="text" name="saleName" size="30"></td>
                            </tr>
                            ...
                            <tr>
                                <td>Price</td>
                                <td>RM <input type="text" name="price" size="30"></td>
                            </tr>
