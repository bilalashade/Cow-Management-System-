...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>CMS - Manage Checkup</title>
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > <a href="menuHealthcare.jsp">Healthcare</a> > Manage Checkup</h2>
                <br></br>
                <input style="width:20%" type="text" id="myInput" onkeyup="myFunction2()" placeholder="Search..." title="Type in Cow Tag">
                    <div align="right"><a href="addCheckup.jsp"><font color="CCA300">Add New Checkup</font></a></div>
                    <br></br>
                    <table id="myTable" border="1" style="width:100%">
                        <tr id="tableHeader">
                            <th onclick="sortTable(0)" align="center">Cow Tag</th>
                            <th onclick="sortTable(1)" align="center">Checkup Date</th>
                            <th onclick="sortTable(2)" align="center">Checkup Time</th>
                            <th onclick="sortTable(3)" align="center">Disease</th>
                            <th onclick="sortTable(4)" align="center">Notes</th>
                            <th></th>
                            <th></th>
                        </tr>
                            <%                                String cowTag = "";
                                ...
                                try {
                                    ...
                                    String querySelect = "select * from checkup, disease where checkup.diseaseID = disease.diseaseID";

                                    ResultSet rows = statement.executeQuery(querySelect);
                                    while (rows.next()) {

                                        cowTag = rows.getString("checkup.cowTag");
                                        checkupDateTime = rows.getString("checkup.checkupDateTime");
                                        ...
                                        Date dCheckupDateTime = ft3.parse(checkupDateTime);
                                        ...
                                        out.println("<td align=center>" + rows.getString("disease.diseaseName") + "</td>");
                                        out.println("<td align=center>" + rows.getString("checkup.notes") + "</td>");
                                        out.println("<td width=5><a href = updateCheckup.jsp?cowTag=" + rows.getString("checkup.cowTag") + "&checkupDate=" + checkupDate + "&checkupTime=" + checkupTime + ">" + "<img width=20 height=20 src=./img/update.png>" + "</a>" + "</td>");
...
<script>
    function myFunction() {
        ...
        if (confirm("Are you sure want to delete this data?")) {
            document.location.href = 'deleteCheckup.jsp?cowTag=<%=cowTag%>&&checkupDate=<%=checkupDate%>&&checkupTime=<%=checkupTime%>';
        } else {
