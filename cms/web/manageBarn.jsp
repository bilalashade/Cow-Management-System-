<%-- 
    Document   : manageBarn
    Created on : Apr 10, 2018, 6:47:14 AM
    Author     : Syafiq
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > <a href="menuBarn.jsp">Barn</a> > Manage Barn </h2>
                <br></br>
                <center><table border="1" width="100%">
                        <form name ="manageBarn" action="manageBarn2.jsp" method="GET">
                            <tr>
                                <td>Cow Tag</td>
                                <td><select name="cowTag">
                                        ...
                                        <%                            Connection connection = null;
                                            try {
                                                ...
                                                String querySelect = "select * from cow where barnID IS NULL";

                                                ResultSet rows = statement.executeQuery(querySelect);
                                                while (rows.next()) {
                                        %>
                                        <option value="<%=rows.getString("cowTag")%>"><%=rows.getString("cowTag")%>
                                            <%
                                                }
                                            %>
                                        </option>
                    ...
                    <br>
                        <input type="submit" value="Submit" onClick="return confirm('Are you sure to insert cow into barn?');"> &nbsp &nbsp
