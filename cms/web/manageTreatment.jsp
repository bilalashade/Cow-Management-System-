                        ...
                        <tr id="tableHeader">
                            ...
                            <%                            String checkupDate = "";
                                ...
                                try {
                                    ...
                                    String querySelect = "select * from checkup, disease where status='untreated' && checkup.diseaseID = disease.diseaseID";
                                    ...
                                    while (rows.next()) {
                                        ...
                                        Date dCheckupDateTime = ft3.parse(rows.getString("checkup.checkupDateTime"));
                                        ...
                                        out.println("<td align=center><a href=addTreatment.jsp?cowTag=" + rows.getString("checkup.cowTag") + "&checkupDate=" + checkupDate + "&checkupTime=" + checkupTime + ">Treat</a>");
                                    }
                                } catch (Exception e) {
                                    out.println("Error" + e);
