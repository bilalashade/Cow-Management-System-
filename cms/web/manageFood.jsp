...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="top">
        ...
        <div class="wrapper">
            <div id="latest">
                <h2><a href="index.jsp">Home</a> > <a href="menuFood.jsp">Food</a> > Manage Food</h2>
                <br></br>
                <input style="width:20%" type="text" id="myInput" onkeyup="myFunction2()" placeholder="Search..." title="Type in Food ID">
                    <div align="right"><a href="addFood.jsp"><font color="CCA300">Add New Food</font></a></div>
                    <div align="left"><a href="reportFood.jsp"><font color="CCA300">Print Report</font></a></div>

                    <br></br>
                    <table id="myTable" border="1" style="width:100%">
                        <tr id="tableHeader">
                            <th onclick="sortTable(0)" align=center>Food ID</th>
                            <th onclick="sortTable(1)" align=center>Food Name</th>
                            <th onclick="sortTable(2)" align=center>Food Type</th>
                            <th onclick="sortTable(3)" align=center>Quantity</th>
                            <th></th>
                            <th></th>
                        </tr>
                        <%                        String foodID = "";
                            ...
                            try {
                                ...
                                while (rows.next()) {
                                    foodID = rows.getString("food.foodID");

                                    out.println("<tr><td align=center>" + rows.getString("food.foodID") + "</td>");
                                    out.println("<td align=center>" + rows.getString("food.foodName") + "</td>");
                                    out.println("<td align=center>" + rows.getString("food.foodType") + "</td>");
                                    out.println("<td align=center>" + rows.getString("food.quantity") + "</td>");
                                    out.println("<td width=5><a href = updateFood.jsp?foodID=" + rows.getString("food.foodID") + ">" + "<img width=20 height=20 src=./img/update.png>" + "</a>" + "</td>");
...
<script>
    function myFunction() {
        ...
        if (confirm("Are you sure want to delete this data?")) {
            document.location.href = 'deleteFood.jsp?foodID=<%=foodID%>';
        } else {
